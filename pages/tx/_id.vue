    ...
    <div class="card section-card">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns" v-if="fees > 0">
          ...
          <div class="column info-value monospace">{{ fees | lbch }} LBCH</div>
        </div>
        ...
        <Transaction
          :transaction="{
            ...
            contractSpends,
            lpp20TokenTransfers, lpp721TokenTransfers
          }"
          detailed
  ...
  export default {
    ...
    async asyncData({req, params, error}) {
      try {
        ...
        return {
          ...
          lpp20TokenTransfers: transaction.lpp20TokenTransfers,
          lpp721TokenTransfers: transaction.lpp721TokenTransfers
        }
      } catch (err) {
    ...
    methods: {
      refresh(transaction) {
        ...
        this.lpp20TokenTransfers = transaction.lpp20TokenTransfers
        this.lpp721TokenTransfers = transaction.lpp721TokenTransfers
      },
      splitData(data) {
